...
public class ActivityController{
	...
	public String create(@RequestBody String body, HttpSession session){
		...
		switch(location){
			case "farm":
				activity = new Activity(location,100,200);
				break;
			case "cave":
				activity = new Activity(location,50,100);
				break;
			case "house":
				activity = new Activity(location,25,500);
				break;
			case "casino":
				activity = new Activity(location,-1500,1500);
				break;
		}
